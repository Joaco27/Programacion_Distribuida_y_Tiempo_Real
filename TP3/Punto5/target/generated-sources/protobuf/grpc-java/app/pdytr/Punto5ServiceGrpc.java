...
public final class Punto5ServiceGrpc {
  ...
  public static final String SERVICE_NAME = "app.pdytr.Punto5Service";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<app.pdytr.MessageProto.MessageRequest,
      app.pdytr.MessageProto.MessageResponse> METHOD_MEASURE =
      io.grpc.MethodDescriptor.<app.pdytr.MessageProto.MessageRequest, app.pdytr.MessageProto.MessageResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "app.pdytr.Punto5Service", "Measure"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              app.pdytr.MessageProto.MessageRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              app.pdytr.MessageProto.MessageResponse.getDefaultInstance()))
  ...
  public static abstract class Punto5ServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void measure(app.pdytr.MessageProto.MessageRequest request,
        io.grpc.stub.StreamObserver<app.pdytr.MessageProto.MessageResponse> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                app.pdytr.MessageProto.MessageResponse>(
  ...
  public static final class Punto5ServiceBlockingStub extends io.grpc.stub.AbstractStub<Punto5ServiceBlockingStub> {
    ...
    /**
     */
    public app.pdytr.MessageProto.MessageResponse measure(app.pdytr.MessageProto.MessageRequest request) {
  ...
  public static final class Punto5ServiceFutureStub extends io.grpc.stub.AbstractStub<Punto5ServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<app.pdytr.MessageProto.MessageResponse> measure(
        app.pdytr.MessageProto.MessageRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MEASURE:
          serviceImpl.measure((app.pdytr.MessageProto.MessageRequest) request,
              (io.grpc.stub.StreamObserver<app.pdytr.MessageProto.MessageResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class Punto5ServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return app.pdytr.MessageProto.getDescriptor();
    }
